...
class SBEx5 extends StatefulWidget {
  ...
  const SBEx5({super.key, required this.title, required this.id, required this.completed});

  @override
  State<SBEx5> createState() => _SBEx5State();
}

class _SBEx5State extends State<SBEx5> {
  ...
  void _validateInput(AllProvider allprovider)async {
    ...
    if (codeRegex.hasMatch(userInput)) {
      ...
      _showDialog(
        ...
        AppLocalizations.of(context)!.exercise5CorrectContent,
      ...
      // Ayuda progresiva según los intentos fallidos
      if (_failedAttempts == 1) {
        _showDialog(
          AppLocalizations.of(context)!.hint1Title,
          AppLocalizations.of(context)!.exercise5Hint1Content,
        );
      } else if (_failedAttempts == 2) {
        _showDialog(
          AppLocalizations.of(context)!.hint2Title,
          AppLocalizations.of(context)!.exercise5Hint2Content,
        );
      } else if (_failedAttempts >= 3) {
        _showDialog(
          AppLocalizations.of(context)!.hint3Title,
          AppLocalizations.of(context)!.exercise5Hint3Content,
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                _showDialog(
                  ...
                  AppLocalizations.of(context)!.exercise5InstructionsContent,
                );
              },
