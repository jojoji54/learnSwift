...
List<CoursesExModel> swiftDictionariesExModelEN = [

   CoursesExModel(
    id: 92,
    exerciseName: 'Dictionary Basics: Retrieve a Value by Key',
   ...
   CoursesExModel(
    id: 93,
    exerciseName: 'Adding Key-Value Pairs to a Dictionary',
   ...
   CoursesExModel(
    id: 94,
    exerciseName: 'Removing Elements from a Dictionary',
   ...
   CoursesExModel(
    id: 95,
    exerciseName: 'Combining Two Dictionaries',
  ...
  CoursesExModel(
    id: 97,
    exerciseName: 'Updating Values in a Dictionary',
   ...
   CoursesExModel(
    id: 98,
    exerciseName: 'Checking for Key Existence in a Dictionary',
   ...
   CoursesExModel(
    id: 99,
    exerciseName: 'Updating and Removing Key-Value Pairs in a Dictionary',
  ...
  CoursesExModel(
    id: 100,
    exerciseName: 'Iterating Over a Dictionary',
  ...
  CoursesExModel(
    id: 101,
    exerciseName: 'Filtering Keys and Values in a Dictionary',
   ...
   CoursesExModel(
    id: 102,
    exerciseName: 'Challenge - Filtering and Updating a Dictionary',
   ...
   CoursesExModel(
    id: 103,
    exerciseName: 'Challenge - Merging Dictionaries and Handling Key Conflicts',
  ...
  CoursesExModel(
    id: 104,
    exerciseName: 'Challenge - Filtering and Modifying a Dictionary ',
