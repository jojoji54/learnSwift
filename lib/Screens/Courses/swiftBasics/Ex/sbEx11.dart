...
class SBEx11 extends StatefulWidget {
     final String title;
  final int id;
  final bool completed;
  const SBEx11({super.key, required this.title, required this.id, required this.completed});

  @override
  State<SBEx11> createState() => _SBEx11State();
}

class _SBEx11State extends State<SBEx11> {
 ...
 void _validateInput(AllProvider allprovider ) {
    ...
    if (codeRegex.hasMatch(userInput)) {
      ...
      _showDialog(
        ...
        AppLocalizations.of(context)!.exercise11CorrectContent,
      ...
      if (_failedAttempts == 1) {
        _showDialog(
          ...
          AppLocalizations.of(context)!.exercise11Hint1Content,
        );
      } else if (_failedAttempts == 2) {
        _showDialog(
          AppLocalizations.of(context)!.hint2Title,
          AppLocalizations.of(context)!.exercise11Hint2Content,
        );
      } else if (_failedAttempts >= 3) {
        _showDialog(
          AppLocalizations.of(context)!.solutionTitle,
          AppLocalizations.of(context)!
              .exercise11SolutionContent
              .replaceAll('@', '{')
              .replaceAll('&', '}'),
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                _showDialog(
                  ...
                  AppLocalizations.of(context)!.exercise11InstructionsContent,
                );
              },
