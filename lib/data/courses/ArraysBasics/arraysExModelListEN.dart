...
List<CoursesExModel> swiftArraysModelEN = [
  ...
  CoursesExModel(
    id: 80,
    exerciseName: 'Array Manipulation\nChallenge',
  ...
  CoursesExModel(
    id: 84,
    exerciseName: 'Count Occurrences in an\nArray',
   ...
   CoursesExModel(
    id: 86,
    exerciseName: 'Find the Maximum in an\nArray',
  ...
  CoursesExModel(
   ...
   CoursesExModel(
    id: 88,
    exerciseName: 'Array Element Removal\nChallenge',
   ...
   CoursesExModel(
    id: 89,
    exerciseName: 'Find the Largest Number\nin an Array',
   ...
   CoursesExModel(
    id: 90,
    exerciseName: 'Combine Two Arrays\ninto One',
