...
enum CodeLanguage { python, javascript, java, cpp, csharp }
...
class CsharpMiniHighlighter {
  static final Set<String> _keywords = {
    'class','public','private','protected','static','readonly','const',
    'void','int','double','float','long','short','byte','char','bool','string',
    'if','else','switch','case','default',
    'for','foreach','while','do','break','continue',
    'try','catch','finally','throw',
    'new','this','return','using','namespace','var',
    'true','false','null'
  };

  static final Set<String> _builtins = {
    'Console','WriteLine','ReadLine','Math','List','DateTime','Exception'
  };
  ...
  static List<TextSpan> highlightLine(String line, {bool showPrompt = false}) {
    final split = _splitCsharpComment(line);
    final codePart = split.code;
    final commentPart = split.comment;
  ...
  static _Split _splitCsharpComment(String line) {
    bool inSingle = false;
    bool inDouble = false;
    bool escaped = false;
            ...
            : language == CodeLanguage.java
                ...
                : language == CodeLanguage.cpp
                    ...
                    : language == CodeLanguage.csharp
                        ? CsharpMiniHighlighter.highlightLine(
                            lines[index],
                            showPrompt: withPrompt,
                          )
