...
final List<ProgrammingItem> programmingItemsZH = [
  ...
  ProgrammingItem(
    ...
    isActive: true,
    description: 'CodeCrafters: Swift 是一款旨在帮助用户学习 Swift 的应用程序，这是一种用于在 Apple 平台上开发应用程序的强大编程语言。包含互动练习，帮助构建 Swift 的扎实基础。\n\n版本: Swift 5.9',
  ),
  ProgrammingItem(
    id: 2,
    name: 'Python',
    ...
    isActive: false,
    description: 'CodeCrafters: Python 教授这种多功能语言，可用于人工智能、数据科学和网页开发。通过实际练习学习真实应用程序。\n\n版本: Python 3.12',
  ),
  ProgrammingItem(
    id: 3,
    name: 'JavaScript',
    ...
    isActive: false,
    description: 'CodeCrafters: JavaScript 是您掌握最广泛用于网页开发的语言的指南，从前端动态效果到完整应用程序。\n\n版本: ECMAScript 2023',
  ),
  ProgrammingItem(
    id: 4,
    name: 'Java',
    ...
    isActive: false,
    description: 'CodeCrafters: Java 教授这一流行的语言，用于企业应用程序、移动应用和稳健系统。\n\n版本: Java 20',
  ),
  ProgrammingItem(
    id: 5,
    name: 'C++',
  ...
  ProgrammingItem(
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: C# 指导您使用此语言进行 Windows 应用程序、电子游戏和企业解决方案开发。\n\n版本: C# 12',
  ),
  ProgrammingItem(
    id: 7,
    name: 'Kotlin',
    ...
    isActive: false,
    description: 'CodeCrafters: Kotlin 是您进入现代 Android 开发的入门语言，功能强大且表达能力丰富。\n\n版本: Kotlin 1.9',
  ),
  ProgrammingItem(
    id: 8,
    name: 'PHP',
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: PHP 介绍这一在后端网页开发中广泛使用的语言，非常适合扩展项目。\n\n版本: PHP 8.3',
  ),
  ProgrammingItem(
    id: 9,
    name: 'Ruby',
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: Ruby 教授这种以其简单和优雅著称的语言，用于网页开发和初创公司。\n\n版本: Ruby 3.3',
  ),
  ProgrammingItem(
    id: 10,
    name: 'Go',
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: Go 是用于学习这一高效语言的工具，非常适合分布式和可扩展系统。\n\n版本: Go 1.21',
  ),
  ProgrammingItem(
    id: 11,
    name: 'COBOL',
    ...
    isActive: false,
    description: 'CodeCrafters: COBOL 是学习这一经典企业语言的指南，用于金融和政府系统。\n\n版本: COBOL 2023',
  ),
  ...
  ProgrammingItem(
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: Flutter 介绍这一强大的跨平台框架，用于开发移动和网页应用程序。\n\n版本: Flutter 3.13',
  ),
  ProgrammingItem(
    id: 13,
    name: 'React',
  ...
  ProgrammingItem(
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: Angular 是用于掌握这一强大框架以开发复杂网页应用的工具。\n\n版本: Angular 16',
  ),
  ProgrammingItem(
    id: 15,
    name: 'Vue.js',
  ...
  ProgrammingItem(
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: Django 教授这一强大的 Python 后端框架，非常适合快速和可扩展的应用程序。\n\n版本: Django 4.2',
  ),
  ProgrammingItem(
    id: 17,
    name: 'Spring',
  ...
  ProgrammingItem(
    ...
    isActive: false,
    description: 'CodeCrafters: Symfony 教授这一强大、模块化的 PHP 框架，用于企业级应用程序。\n\n版本: Symfony 6.3',
  ),
  ProgrammingItem(
    id: 19,
    name: 'Laravel',
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: Laravel 是学习这一以优雅和简单著称的 PHP 框架的工具。\n\n版本: Laravel 10',
  ),
  ProgrammingItem(
    id: 20,
    name: 'ASP.NET',
  ...
  ProgrammingItem(
    ...
    color2: Color(0xFFFFFFFF),
    isActive: false,
    description: 'CodeCrafters: TensorFlow 是构建人工智能和机器学习模型的指南。\n\n版本: TensorFlow 2.13',
  ),
