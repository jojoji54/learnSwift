...
class ArraysEx80 extends StatefulWidget {
  final String title;
  final int id;
  final bool completed;
  const ArraysEx80({super.key, required this.title, required this.id, required this.completed});

  @override
  State<ArraysEx80> createState() => _ArraysEx80State();
}

class _ArraysEx80State extends State<ArraysEx80> {
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                _showDialog(
                  ...
                  "Welcome to Array Manipulation Challenge! 🎉\n\n"
                  "Your task:\n"
