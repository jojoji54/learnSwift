...
List<CoursesExModel> swiftArraysModelES = [

  CoursesExModel(
    id: 76,
    exerciseName: 'Acceder a Elementos del Arreglo',
  ...
  CoursesExModel(
    id: 77,
    exerciseName: 'Agregar e Imprimir Elementos',
  ...
  CoursesExModel(
    id: 78,
    exerciseName: 'Reemplazar un Elemento',
  ...
  CoursesExModel(
    id: 79,
    exerciseName: 'Agregar y Eliminar Elementos',
  ...
  CoursesExModel(
    id: 80,
    exerciseName: 'Desafío de Manipulación de Arreglos',
  ...
  CoursesExModel(
   ...
   CoursesExModel(
    id: 82,
    exerciseName: 'Desafío de Suma de Arreglos',
  ...
  CoursesExModel(
    id: 84,
    exerciseName: 'Contar Ocurrencias en un Arreglo',
   ...
   CoursesExModel(
    id: 85,
    exerciseName: 'Invertir un Arreglo',
   ...
   CoursesExModel(
    id: 86,
    exerciseName: 'Encontrar el Máximo en un Arreglo',
  ...
  CoursesExModel(
    id: 87,
    exerciseName: 'Filtrar Números Pares',
   ...
   CoursesExModel(
    id: 88,
    exerciseName: 'Desafío de Eliminación de Elementos',
   ...
   CoursesExModel(
    id: 89,
    exerciseName: 'Encontrar el Número Más Grande en un Arreglo',
   ...
   CoursesExModel(
    id: 90,
    exerciseName: 'Combinar Dos Arreglos en Uno',
   ...
   CoursesExModel(
    id: 91,
    exerciseName: 'Combinar y Ordenar Arreglos',
