...
class SBEx4 extends StatefulWidget {
    final String title;
  final int id;
  final bool completed;
  const SBEx4({super.key, required this.title, required this.id, required this.completed});

  @override
  State<SBEx4> createState() => _SBEx4State();
}

class _SBEx4State extends State<SBEx4> {
  ...
  void _validateInput(AllProvider allprovider)async {
    ...
    if (codeRegex.hasMatch(userInput)) {
      ...
      _showDialog(
        ...
        AppLocalizations.of(context)!.exercise4CorrectContent,
      ...
      if (_failedAttempts == 1) {
        _showDialog(
          ...
          AppLocalizations.of(context)!.exercise4Hint1Content,
        );
      } else if (_failedAttempts == 2) {
        _showDialog(
          AppLocalizations.of(context)!.hint2Title,
          AppLocalizations.of(context)!.exercise4Hint2Content,
        );
      } else if (_failedAttempts >= 3) {
        _showDialog(
          AppLocalizations.of(context)!.hint3Title,
          AppLocalizations.of(context)!.exercise4Hint3Content,
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                _showDialog(
                  ...
                  AppLocalizations.of(context)!.exercise4InstructionsContent,
                );
              },
