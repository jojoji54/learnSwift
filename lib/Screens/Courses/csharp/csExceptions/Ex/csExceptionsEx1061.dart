...
class _CSharpExceptionsEx1061State extends State<CSharpExceptionsEx1061> {
  ...
  void _submit(AllProvider allprovider) {
    ...
    if (_isValid1061(userInput)) {
      ...
      if (_failedAttempts == 1) {
        _showDialog(_t(loc.csharp1061HintTitle1), _t(loc.csharp1061HintContent1));
      } else if (_failedAttempts == 2) {
        _showDialog(_t(loc.csharp1061HintTitle2), _t(loc.csharp1061HintContent2));
      } else {
        _showDialog(
          _t(loc.csharp1061SolutionTitle),
          _t(loc.csharp1061SolutionContent),
  ...
  Widget build(BuildContext context) {
    ...
    final exampleLines = <String>[
      _t(loc.csharp1061ExampleCode1),
      _t(loc.csharp1061ExampleCode2),
      _t(loc.csharp1061ExampleCode3),
    ];
        ...
        children: [
          Padding(
            ...
            child: FloatingActionButton(
              heroTag: "introButtonCSharp1061",
              onPressed: () {
                _showDialog(
                  _t(loc.csharp1061InstructionsTitle),
                  _t(loc.csharp1061InstructionsContent),
                );
              },
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: FloatingActionButton(
              heroTag: "infoButtoncsharp1061",
              onPressed: () {
                _showDialog(
                  _t(loc.csharp1061InfoTitle),
                  _t(loc.csharp1061InfoContent),
                );
              },
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                Text(
                  _t(loc.csharp1061ExampleOutput),
                  style: const TextStyle(
                    fontFamily: 'InconsolataRegular',
                    fontSize: 16,
                    color: Colors.grey,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: _t(loc.csharp1061EnterCodeHint),
