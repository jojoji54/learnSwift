...
List<CoursesExModel> switchModelEN = [
  ...
  CoursesExModel(
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(47).completed!,
  ),
   CoursesExModel(
    id: 48,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(48).completed!,
  ),
   CoursesExModel(
    id: 49,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(49).completed!,
  ),
   CoursesExModel(
    id: 50,
    exerciseName: 'Switch with Multiple\nMatches',
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(50).completed!,
  ),
   CoursesExModel(
    id: 51,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(51).completed!,
  ),
   CoursesExModel(
    id: 52,
    exerciseName: 'Switch with Multiple\nValues Per Case',
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(52).completed!,
  ),
   CoursesExModel(
    id: 53,
    exerciseName: 'Switch with Ranges\nand Default Case',
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(53).completed!,
  ),
   CoursesExModel(
    id: 54,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(54).completed!,
  ),
   CoursesExModel(
    id: 55,
    exerciseName: 'Nested Switch Cases',
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(55).completed!,
  ),
   CoursesExModel(
    id: 56,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(56).completed!,
  ),
   CoursesExModel(
    id: 57,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(57).completed!,
  ),
   CoursesExModel(
    id: 58,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(58).completed!,
  ),
     CoursesExModel(
    id: 59,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(59).completed!,
  ),
    CoursesExModel(
    id: 60,
    ...
    completed:
        PurchaseManagerSingleton().purchaseAndDevelop.elementAt(60).completed!,
  ),
];
