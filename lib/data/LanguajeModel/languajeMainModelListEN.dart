...
import 'package:learnswift/data/mainModel/Laravel/CoursesMainModelListEN.dart';
...
import 'package:learnswift/data/mainModel/ASPNet/CoursesMainModelListEN.dart';
...
final List<ProgrammingItem> programmingItemsEN = [
  ...
  ProgrammingItem(
    ...
    coursesList: coursesLaravelMainModelListEN,
  ...
  ProgrammingItem(
    ...
    coursesList: coursesAspNetMainModelListEN,
