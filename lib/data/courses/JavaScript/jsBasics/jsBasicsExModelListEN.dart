...
// Nota: usa el mismo import de purchaseManagerHive que ya tienes en tus otras listas
// (no lo pongo porque en tu snippet no sale la ruta exacta).

List<CoursesExModel> jsBasicsModelEN = [
  CoursesExModel(
    id: 300,
    exerciseName: 'Hello, JavaScript!',
  ...
  CoursesExModel(
    id: 302,
    exerciseName: 'Variables: let & const',
  ...
  CoursesExModel(
    id: 307,
    exerciseName: 'Comparison Operators',
