...
List<CoursesExModel> pyBasicsExModelListES = [
  ...
  CoursesExModel(
    id: 151,
    exerciseName: 'Print()',
    productID: 'com.mrrubik.learnswift.pythonbasicex151',
    alreadyBuy: purchaseManagerHive.getPurchasedTrue(151),
    completed: purchaseManagerHive.getCompleted(151),
  ),
  CoursesExModel(
    id: 152,
    exerciseName: 'Input()',
    productID: 'com.mrrubik.learnswift.pythonbasicex152',
    alreadyBuy: purchaseManagerHive.getPurchasedTrue(152),
    completed: purchaseManagerHive.getCompleted(152),
  ),
  CoursesExModel(
    id: 153,
