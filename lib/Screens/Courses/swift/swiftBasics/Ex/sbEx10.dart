...
class SBEx10 extends StatefulWidget {
  ...
  const SBEx10({super.key, required this.title, required this.id, required this.completed});

  @override
  State<SBEx10> createState() => _SBEx10State();
}

class _SBEx10State extends State<SBEx10> {
  ...
  void _validateInput(AllProvider allprovider ) {
    ...
    if (codeRegex.hasMatch(userInput)) {
      ...
      _showDialog(
        ...
        AppLocalizations.of(context)!.exercise10CorrectContent,
      ...
      if (_failedAttempts == 1) {
        _showDialog(
          ...
          AppLocalizations.of(context)!.exercise10Hint1Content,
        );
      } else if (_failedAttempts == 2) {
        _showDialog(
          AppLocalizations.of(context)!.hint2Title,
          AppLocalizations.of(context)!.exercise10Hint2Content,
        );
      } else if (_failedAttempts >= 3) {
        _showDialog(
          AppLocalizations.of(context)!.solutionTitle,
          AppLocalizations.of(context)!.exercise10SolutionContent,
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                _showDialog(
                  ...
                  AppLocalizations.of(context)!.exercise10InstructionsContent,
                );
              },
