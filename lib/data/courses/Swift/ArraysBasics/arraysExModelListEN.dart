...
List<CoursesExModel> swiftArraysModelEN = [

  CoursesExModel(
    id: 76,
    exerciseName: 'Accessing Array Elements',
  ...
  CoursesExModel(
    id: 77,
    exerciseName: 'Add and Print Elements',
  ...
  CoursesExModel(
    id: 78,
    exerciseName: 'Replace an Element',
  ...
  CoursesExModel(
    id: 79,
    exerciseName: 'Add and Remove Elements',
  ...
  CoursesExModel(
    id: 80,
    exerciseName: 'Array Manipulation Challenge',
  ...
  CoursesExModel(
   ...
   CoursesExModel(
    id: 82,
    exerciseName: 'Array Sum Challenge',
  ...
  CoursesExModel(
    id: 84,
    exerciseName: 'Count Occurrences in an Array',
   ...
   CoursesExModel(
    id: 86,
    exerciseName: 'Find the Maximum in an Array',
  ...
  CoursesExModel(
    id: 87,
    exerciseName: 'Filter Even Numbers',
   ...
   CoursesExModel(
    id: 88,
    exerciseName: 'Array Element Removal Challenge',
   ...
   CoursesExModel(
    id: 89,
    exerciseName: 'Find the Largest Number in an Array',
   ...
   CoursesExModel(
    id: 90,
    exerciseName: 'Combine Two Arrays into One',
   ...
   CoursesExModel(
    id: 91,
    exerciseName: 'Combine and Sort Arrays',
